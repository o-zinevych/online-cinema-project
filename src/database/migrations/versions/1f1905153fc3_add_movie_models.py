...
Revision ID: 1f1905153fc3
Revises: 3fdfe1bf8d7c
Create Date: 2025-09-16 13:39:11.772393
...
revision: str = '1f1905153fc3'
down_revision: Union[str, Sequence[str], None] = '3fdfe1bf8d7c'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'year', 'time', name='movie_name_year_time_constraint'),
