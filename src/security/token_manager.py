...
from exceptions.security import ExpiredTokenError, InvalidTokenError
...
class JWTAuthManager(JWTAuthManagerInterface):
    ...
    def _create_token(
        ...
        """
        Creates a JWT token with the provided data, secret key, and expiration time.
        """
        to_encode = data.copy()
    ...
    def create_access_token(
        ...
        """
        Creates a new access token with a default or given expiration time.
        """
    ...
    def create_refresh_token(
        ...
        """
        Creates a new refresh token with a default or given expiration time.
        """
        return self._create_token(
            data,
    ...
    def decode_access_token(self, token: str) -> dict:
        """
        Decodes and validates an access token. Returns this token's data.
        """
        try:
            return jwt.decode(
    ...
    def decode_refresh_token(self, token: str) -> dict:
        """
        Decodes and validates a refresh token. Returns this token's data.
        """
        try:
            return jwt.decode(
